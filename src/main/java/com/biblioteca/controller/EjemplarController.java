...
public class EjemplarController {
    ...
    @PostMapping
    public ResponseEntity<EjemplarResponse> crearEjemplar(
    ...
    @GetMapping("/{id}")
    public ResponseEntity<EjemplarResponse> consultarEjemplar(
    ...
    public ResponseEntity<EjemplarResponse> actualizarEjemplar(
        ...
        EjemplarResponse response =
                ejemplarService.actualizarEjemplar(id, request);
